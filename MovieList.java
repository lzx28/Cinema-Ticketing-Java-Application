...
public class MovieList extends JFrame implements ActionListener, ItemListener
{
	...
	public void itemStateChanged(ItemEvent e)
	{
		if(movieNumber == 1)
		{
			if(e.getSource() instanceof JRadioButton)
			{
				...
				{
					date = "16/12/2019";
					Date[0].setBackground(Color.green);	
				...
				{
					date = "17/12/2019";
					Date[1].setBackground(Color.green);	
				...
				{
					date = "18/12/2019";
					Date[2].setBackground(Color.green);	
				...
				{
					date = "19/12/2019";
					Date[3].setBackground(Color.green);	
				...
				{
					date = "20/12/2019";
					Date[4].setBackground(Color.green);	
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		{
			Movie[0].setBackground(Color.green);
			for(int i=0; i<4; i++)
			{
		...
		{	//movie 2
			Movie[1].setBackground(Color.green);
			for(int i=0; i<4; i++)
			{
				Movie[i].setEnabled(false);
			}
		...
		{
			Movie[2].setBackground(Color.green);
			for(int i=0; i<4; i++)
			{
				Movie[i].setEnabled(false);
			}
		...
		{
			Movie[3].setBackground(Color.green);
			for(int i=0; i<4; i++)
			{
				Movie[i].setEnabled(false);
			}
