...
public class AddOn extends JFrame implements ActionListener
{
	...
	public AddOn()
	{
		...
		JLabel jl2 = new JLabel("E-Combo 1");
		p2.add(jl2);
		...
		JLabel jl3 = new JLabel("E-Combo 2");
		p3.add(jl3);
		...
		JLabel jl4 = new JLabel("E-Combo 3");
		p4.add(jl4);
